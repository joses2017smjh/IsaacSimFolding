...
LH_FORWARD_VARS="SAVE_FREQ EVAL_ONLY STAGE_STEPS HF_TOKEN FETCH_DEPTH CONFIG VALUE_PATH FEATURE_PATH HIDDEN_DIM POLICY_PATH_OVR ROLLOUT_DIR SHARED_DIR WORKER_ID N_CANDIDATES STAGE_OUT GARMENT_TYPE NUM_EPISODES MAX_STEPS POLICY_TYPE POLICY_PATH DATASET_ROOT PROBE_OUT OUT_CSV SEED DEVICE ENABLE_CAMERAS HEADLESS HF_HOME STEP_HZ RUN_NAME"
